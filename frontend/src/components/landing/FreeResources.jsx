        ...
        <div className="grid lg:grid-cols-[1.15fr_1fr] gap-12 lg:gap-16 items-center">
          ...
          <Reveal delay={0.15}>
            <div className="relative">
              <div className="hidden lg:block absolute -top-24 right-2"><DoodleBooks /></div>
              <div className="rounded-3xl border border-slate-200 bg-white/80 backdrop-blur p-7">
                ...
                <div className="flex flex-wrap gap-2.5">
                  {RESOURCE_TRACKS.map((t) => (
                    <a
                      key={t.id}
                      href="#resources"
                      className="px-4 py-2 rounded-full border border-slate-300 text-slate-700 text-[14px] hover:border-blue-500 hover:text-blue-700 transition-colors"
                    >
                      {t.short}
                    </a>
                  ))}
